...
GLMesh GLFlatMeshGenerator::generate(const unsigned mesh_steps) const
{
    GLMesh mesh{};
...
void GLFlatMeshGenerator::init_vertices(std::vector<GLVertex>& vertices, unsigned mesh_steps) const
{
...
void GLFlatMeshGenerator::init_indices(std::vector<unsigned>& indices, unsigned const mesh_steps) const
{
